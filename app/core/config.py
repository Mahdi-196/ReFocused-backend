...
class Settings(BaseSettings):
    ...
    JWT_SIGNING_ALG: str = Field("HS256", env="JWT_SIGNING_ALG")
    ...
    REMEMBER_ME_EXPIRE_DAYS: int = Field(30, env="REMEMBER_ME_EXPIRE_DAYS")
    PASSWORD_HASHER: str = Field("bcrypt", env="PASSWORD_HASHER")
    BCRYPT_ROUNDS: int = Field(10, env="BCRYPT_ROUNDS")
    ...
    COOKIE_MAX_AGE: int = Field(86400 * 30, env="COOKIE_MAX_AGE")

    SESSION_EXPIRE_MINUTES: int = Field(480, env="SESSION_EXPIRE_MINUTES")
    ...
    AUTO_REFRESH_THRESHOLD_MINUTES: int = Field(5, env="AUTO_REFRESH_THRESHOLD_MINUTES")
    AUTO_REFRESH_ENABLED: bool = Field(True, env="AUTO_REFRESH_ENABLED")

    SLIDING_SESSION_ENABLED: bool = Field(True, env="SLIDING_SESSION_ENABLED")
    SLIDING_SESSION_REFRESH_HOURS: int = Field(24, env="SLIDING_SESSION_REFRESH_HOURS")
    SLIDING_SESSION_ABSOLUTE_MAX_DAYS: int = Field(60, env="SLIDING_SESSION_ABSOLUTE_MAX_DAYS")
    ...
    DATABASE_POOL_TIMEOUT: int = Field(5, env="DATABASE_POOL_TIMEOUT")
    ...
    RATE_LIMIT_MAX_REQUESTS: int = Field(500, env="RATE_LIMIT_MAX_REQUESTS")
    ...
    GLOBAL_RATE_LIMIT_REFILL_RATE: float = Field(2.0, env="GLOBAL_RATE_LIMIT_REFILL_RATE")
    ...
    EMAIL_API_PREFIX: str = Field("", env="EMAIL_API_PREFIX")
    ...
    FEATURE_VOTING_ENDPOINT: Optional[str] = Field(None, env="FEATURE_VOTING_ENDPOINT")
    VOTING_API_KEY: Optional[str] = Field(None, env="VOTING_API_KEY")
    VOTING_API_PREFIX: str = Field("", env="VOTING_API_PREFIX")
